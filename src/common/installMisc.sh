...
# Installing mods cli (https://github.com/charmbracelet/mods)
echo "Installing the mods CLI..."
if ! isProgramInstalled mods; then
	echo '[charm]
name=Charm
...
gpgkey=https://repo.charm.sh/yum/gpg.key' | sudo tee /etc/yum.repos.d/charm.repo
	sudo dnf install mods -y
else
	echo "The mods CLI has already been installed. Moving on..."
fi
echo -e "\n"
