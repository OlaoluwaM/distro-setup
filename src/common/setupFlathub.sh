...
flatpakApplicationIds=("rest.insomnia.Insomnia" "com.spotify.Client" "it.mijorus.gearlever" "org.gnome.Extensions" "org.gnome.Chess" "com.discordapp.Discord" "im.riot.Riot" "md.obsidian.Obsidian" "com.github.micahflee.torbrowser-launcher" "me.timschneeberger.GalaxyBudsClient" "net.ankiweb.Anki" "com.vixalien.sticky" "org.gimp.GIMP" "org.gnome.design.IconLibrary" "com.mattjakeman.ExtensionManager" "net.nokyan.Resources" "io.github.vikdevelop.SaveDesktop")
