...
declare -A repos=(["distro-setup"]="$labsPath" ["snippets"]="$labsPath" ["dotfiles"]="$labsHomePath" ["haskell-from-first-principles-exercies"]="$labsPath" ["sicp-exercises"]="$labsPath" ["advent-of-code"]="$labsPath" ["parallel-and-concurrent-programming-in-haskell"]="$labsPath")
