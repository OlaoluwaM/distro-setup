...
if command -v git &>/dev/null || command -v gh &>/dev/null; then
  ...
  reposInDevFolder=("distro-setup" "term-of-the-day" "surfshark-vpn-cli" "bitwarden-auto-unlock" "configs" "scaffy" "dotfilers" "coding-prob-patterns" "dev-vault" "notion-catppuccin" "coding-prob-patterns")
